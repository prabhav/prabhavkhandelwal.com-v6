var main = function() {
    ...
    //     function () {
    //        $('.box--work').css({"background-image":"url('/assets/img/wall/labamba_gif.gif')"});
    //         $('.box--work .point').addClass('hidden');
    //         $(this).removeClass('hidden');
    //     }, 
         
    //     function () {
    //        $('.box--work').css({"background-image":"none"});
    //        $('.box--work .point').removeClass('hidden');
    //     //    $('.box--work').removeClass("contain-bg");
    //     }
    //  );
...
// canvas
    ...
    function drawLine(ctx,x,y,size) {
        ...
        var r=242; var g=38; var b=19; var a=255;
