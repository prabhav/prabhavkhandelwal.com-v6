module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      html_refresh: {
        files: ["*.html", "*.md", "*.markdown", "_includes/*.html", "_layouts/*.html", "_work/*", "_blog/*"],
      ...
      css: {
        files: ['assets/scss/*.scss', 'assets/scss/partials/*.scss'],
  ...
  grunt.registerTask('default', ['concat', 'uglify', 'sass', "shell:jekyllBuild", 'watch']);
